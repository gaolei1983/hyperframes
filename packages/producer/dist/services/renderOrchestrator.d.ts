...
export declare function collectVideoReadinessSkipIds(
...
export declare function collectVideoMetadataHints(
  extractedVideos: readonly ExtractedVideoReadinessInput[],
): CaptureVideoMetadataHint[];
export declare function findMissingFrameRanges(
  totalFrames: number,
  framesDir: string,
  frameExt: "jpg" | "png",
): FrameRange[];
export declare function buildMissingFrameRetryBatches(
  ranges: FrameRange[],
  maxWorkers: number,
  workDir: string,
  attempt: number,
...
export declare function closeHdrVideoFrameSource(
  source: HdrVideoFrameSource,
  log?: ProducerLogger,
): void;
export declare function blitHdrVideoLayer(
  canvas: Buffer,
 ...
 */
export declare function blitHdrImageLayer(
  canvas: Buffer,
  el: ElementStackingInfo,
...
export declare function resolveCompositeTransfer(
  hasHdrContent: boolean,
  effectiveHdr:
    | {
 ...
 */
export declare function compositeHdrFrame(
...
export declare function shouldUseStreamingEncode(
 ...
 */
export declare function extractStandaloneEntryFromIndex(
  indexHtml: string,
  entryFile: string,
): string | null;
/**
 ...
 */
export declare function executeRenderJob(
  job: RenderJob,
  projectDir: string,
  outputPath: string,
